...
const usecase6_StartDate = "Jun 01, " + year;
const usecase6_EndDate = "Jun 25, " + year;
/**** END CONSTANTS FOR USECASE:6 ******/

describe("promouie2e-uc6", function () {
    ...
    it("should fill initial promotion fields and save", async () => {
        ...
        await promotionDetailsPage.iFillTheStartDateField(usecase6_StartDate);
        await promotionDetailsPage.iFillTheEndDateField(usecase6_EndDate);
